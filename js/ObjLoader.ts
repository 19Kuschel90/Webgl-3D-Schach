class ObjLoader{
	static domToMesh(meshName:any,elmID:any,flipYUV:any):any{ 
		var d = ObjLoader.parseFromDom(elmID,flipYUV);
		return gl.fCreateMeshVAO(meshName,d[0],d[1],d[2],d[3],3);
	}

	static parseFromDom(elmID:any,flipYUV:any){ return ObjLoader.parseObjText((<HTMLElement> document.getElementById(elmID)).innerHTML,flipYUV); }
	
	static parseObjText(txt:any,flipYUV: any){
