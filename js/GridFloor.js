...
var C_GridFloor = /** @class */ (function () {
    ...
    C_GridFloor.prototype.createShader = function () {
    ...
    C_GridFloor.prototype.render = function (camera) {
    ...
    C_GridFloor.prototype.createMesh = function (gl, incAxis) {
        //Dynamiclly create a grid
        var verts = [], size = 2, // W/H of the outer box of the grid, from origin we can only go 1 unit in each direction, so from left to right is 2 units max
...
//# sourceMappingURL=GridFloor.js.map